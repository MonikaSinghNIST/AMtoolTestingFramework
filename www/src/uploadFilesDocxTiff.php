...
<link rel="stylesheet" type="text/css" href="css/layout.css" media="screen" />
	...
	function redirect(){
	 ...
	 document.getElementById('frm').action = 'GenerateDataSetDocxTiffWithImages.php';
	/*
    	    ...
    	    <div id="breadcrumb"></div> 
			  <form id="frm" method="post" action="javascript:editXMLDoc();" enctype="multipart/form-data">
				  <table>
                      ...
                      <tr><td width="50%">Enter the folder containing TIFF images</td><td align="right" style="text-align: right"><div align="right"><input accept="image/tiff" required="" type="file" name="tiff[]" id="tiff" multiple=""></div></td></tr> 
