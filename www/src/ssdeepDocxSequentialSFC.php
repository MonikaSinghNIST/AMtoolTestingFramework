			  ...
			  <form id="frm" method="get" action="javascript:redirect();">
				 <?php 
				  ...
				  ?>
						 ...
						 echo exec('ssdeep -r Data\Results\DOCX\Sequentialfragment\Result >ssdeepFregDocx1.text');
						  
						 echo exec('ssdeep -r Data\Results\DOCX\Sequentialfragment\Docx >ssdeepFregDocx2.text');
						  
						  $rslt= exec('ssdeep -k ssdeepFregDocx1.text ssdeepFregDocx2.text >ssdeepFregSeqDocx.text');
						  
						  $rslt = file_get_contents('ssdeepFregSeqDocx.text', true);
					  $sn=0;
...
$numOfFrgmntFl=0;
$numOfTxtFl=0;
$fi1 = new FilesystemIterator("Data\Results\DOCX\Sequentialfragment\Result", FilesystemIterator::SKIP_DOTS);
$numOfFrgmntFl=iterator_count($fi1);
$fi2 = new FilesystemIterator("Data\Results\DOCX\Sequentialfragment\Docx", FilesystemIterator::SKIP_DOTS);
