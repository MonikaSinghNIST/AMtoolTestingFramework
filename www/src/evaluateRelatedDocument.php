...
function fragment_identification(){
	...
	document.location.href = 'all.php?threshold='+ threshold;
...
function smallest_fragment_correlation(){
	...
	document.location.href = 'ComparativeAssessmentMultipleBlock.php?threshold='+ threshold;
...
<body id="menu1"> 
	<div id="mainWrapper">
		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	    <div id="breadcrumb">Related Document Detection ➤ <a href="evaluateRelatedDocument.php">Test Cases</a></div> 
			  ...
			  <form id="frm" method="get" action="javascript:redirect();">
				  <table class="" style="border: thick;">
					  ...
					  <tr><td style="border-left: medium;border-left-color: black;"><div id="breadcrumb"><a href="evaluate_related_document_identification.php">Single Block Identification</a></div><div style="font-size:9px; color:#F00;">*Perform customized test</div></td><td style="text-align: right;">
					...
					<td style="border-left: none; border-bottom: none;"><input type="button" align="right" id="button_embedded" name="button_embedded" value="Comparative Assessment" onClick="fragment_identification();" ></td></tr><tr><td style="align-items: flex-end;text-align: right; border-right: none;border-bottom: none;"><div style="font-size: 10px;color: red;"  >Enter Threshold  </div><div style="font-size: 8px;color: red;"  >(score value, used to 	separate matches from non-matches.)</div></td><td style="align-items: flex-end;text-align: right; border-right: none;border-bottom: none;border-left: none;"></td></tr></table>
                      ...
                      <tr><td style="border-left: medium;border-left-color: black;"><div id="breadcrumb"><a href="evaluate_related_document_identification_multiBlock.php">Multiple Block Identification</a></div><div style="font-size:9px; color:#F00;">*Perform customized test</div></td><td style="text-align: right;">
