...
foreach($deltxtfiles as $deltxtfile){ // iterate files
	...
	$deltxtfiles = glob('../DataUserGenerated\FragmentIdentification\DocxData\Random\Docx\*'); // get all file names
foreach($deltxtfiles as $deltxtfile){ // iterate files
 	if(is_file($deltxtfile))
    unlink($deltxtfile); // delete file
}
	...
	$delRsltfiles = glob('../DataUserGenerated\FragmentIdentification\DocxData\Random\Results\*'); // get all file names
...
?>
 ...
 <?php  
 		//echo exec('javac -cp "javasrc/jar/poi-3.16.jar;javasrc/jar/poi-ooxml-3.16.jar;javasrc/jar/poi-ooxml-3.16.jar;javasrc/jar/poi-ooxml-schemas-3.16.jar;javasrc/jar/xmlbeans-2.6.0.jar;javasrc/jar/zip4j_1.3.2.jar" javasrc/DocxFragmentRandom.java');
		
		echo exec('java -cp "javasrc/jar/poi-3.16.jar;javasrc/jar/poi-ooxml-3.16.jar;javasrc/jar/poi-ooxml-3.16.jar;javasrc/jar/poi-ooxml-schemas-3.16.jar;javasrc/jar/xmlbeans-2.6.0.jar;javasrc/jar/zip4j_1.3.2.jar;." javasrc.DocxFragmentRandom');
	...
	//$path = 'D:\\Pictures\\'; 
//exec("explorer '" . $path . "'");
	$fi1_1 = new FilesystemIterator("../DataUserGenerated\FragmentIdentification\DocxData\Random\Results", FilesystemIterator::SKIP_DOTS);
$numOfFile=iterator_count($fi1_1);
	...
	?>
                      ...
                      <tr><td><div id="breadcrumb" align="center"><a href="../DataUserGenerated//FragmentIdentification//DocxData//Random//Results//" target="_blank" >Find the fragment files here</a></div></td></tr>
                      <tr><td><div id="breadcrumb" align="center"><a href="../DataUserGenerated//FragmentIdentification//DocxData//Random//Docx//" target="_blank" >Find the source files here</a></div></td></tr>
