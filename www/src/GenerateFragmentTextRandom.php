...
/////////////////////////////////////////////////Empty the folder docx and jpeg to generate new data-set. /////////////////////////////////////////////////////////////////	
	$deltxtfiles = glob('../DataUserGenerated\FragmentIdentification\TextData\Random\Text\*'); // get all file names
foreach($deltxtfiles as $deltxtfile){ // iterate files
	...
	$delRsltfiles = glob('../DataUserGenerated\FragmentIdentification\TextData\Random\Results\*'); // get all file names
		...
		for($i=0; $i<$total; $i++) {
		 ...
		 //echo "Path: ".$tmpFilePath;
		  ...
		  if ($tmpFilePath != ""){
			...
			$newFilePath = "../DataUserGenerated/FragmentIdentification/TextData/Random/Text/" . $_FILES['textFiles']['name'][$i];
		//echo "In if!!";
...
?>
 ...
 <?php  //echo exec('javac javasrc/TextFragmentRandomPHP.java'); 
		echo exec('java javasrc.TextFragmentRandomPHP');
	...
	//$path = 'D:\\Pictures\\'; 
//exec("explorer '" . $path . "'");
	$fi1_1 = new FilesystemIterator("../DataUserGenerated\FragmentIdentification\TextData\Random\Results", FilesystemIterator::SKIP_DOTS);
$numOfFile=iterator_count($fi1_1);
	...
	?>
					  ...
					  <tr><td colspan="2"><div id="breadcrumb" align="center"><?php echo $numOfFile; ?> embedded fils has been generated.&nbsp;&nbsp;<a href="../DataUserGenerated//FragmentIdentification//TextData//Random//Results//" target="_blank" >Find here</a></div></td></tr>
