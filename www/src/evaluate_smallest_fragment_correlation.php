...
function redirect(){
   ...
   document.getElementById('frm').action = 'ssdeepSFC.php?case=1&threshold='+threshold;
  }else if((dataSet=="Existing") && (setType == "DOCX") && (contains=="random")) {
   document.getElementById('frm').action = 'ssdeepSFC.php?case=2&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'ssdeepSFC.php?case=3&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (contains=="random") && (tool== "ssdeep")) {
   document.getElementById('frm').action = 'ssdeepSFC.php?case=4&threshold='+threshold;
  }
	else if((dataSet=="Existing") && (setType == "TEXT") && (contains=="sequencial") ) {
  
		document.getElementById('frm').action = 'ssdeepSFC.php?case=5&threshold='+threshold;
  }else if((dataSet=="Existing") && (setType == "TEXT") && (contains=="random") && (tool== "ssdeep")) {
   document.getElementById('frm').action = 'ssdeepSFC.php?case=6&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'ssdeepSFC.php?case=7&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (contains=="random") && (tool== "ssdeep")) {
   document.getElementById('frm').action = 'ssdeepSFC.php?case=8&threshold='+threshold;
  }
	}else if(tool== "sdhash"){
	
	if((dataSet=="Existing") && (setType == "DOCX") && (contains=="sequencial")  ) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=1&threshold='+threshold;
  }else if((dataSet=="Existing") && (setType == "DOCX") && (contains=="random")) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=2&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=3&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (contains=="random")) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=4&threshold='+threshold;
  }else if((dataSet=="Existing") && (setType == "TEXT") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=5&threshold='+threshold;
  }else if((dataSet=="Existing") && (setType == "TEXT") && (contains=="random")) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=6&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=7&threshold='+threshold;
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (contains=="random")) {
   document.getElementById('frm').action = 'sdhashSFC.php?case=8&threshold='+threshold;
  }
  ...
  //////////////////////
   ...
   if((dataSet=="Existing") && (setType == "DOCX") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=1&threshold='+threshold+'&tool='+tool;
  }else if((dataSet=="Existing") && (setType == "DOCX") && (contains=="random")) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=2&threshold='+threshold+'&tool='+tool;
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=3&threshold='+threshold+'&tool='+tool;
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (contains=="random")) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=4&threshold='+threshold+'&tool='+tool;
  }else if((dataSet=="Existing") && (setType == "TEXT") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=5&threshold='+threshold+'&tool='+tool;
  }else if((dataSet=="Existing") && (setType == "TEXT") && (contains=="random")) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=6&threshold='+threshold+'&tool='+tool;
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (contains=="sequencial") ) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=7&threshold='+threshold+'&tool='+tool;
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (contains=="random")) {
   document.getElementById('frm').action = 'other_toolsSFC.php?case=8&threshold='+threshold+'&tool='+tool;
  }
...
<body id="menu1"> 
	<div id="mainWrapper">
		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	    <div id="breadcrumb">Fragment Identification ➤ <a href="evaluateFragment.php">Test Cases</a> ➤ <a href="evaluate_smallest_fragment_correlation.php">Smallest  Fragment  Identification</a></div> 
			  <form id="frm" method="post" action="javascript:redirect();">
				  <table>
					  ...
					  <!--<tr><td><a href="ListEmbeddedObject.php">Embedded Object Based Search</a></td><td><a href="ListEmbeddedObject.php">DOCX</a>&nbsp;&nbsp;<a href="ListEmbeddedObjectPPTX.php">PPTX</a></td></tr>-->
