...
<body id="menu1"> 
	<div id="mainWrapper">
		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	   	  <div id="breadcrumb">Smallest Fragment Correlation (ssdeep)</div> 
				 ...
				 <?php $tblid=1; ?>
				  ...
				  ?>
						 ...
						 echo exec('ssdeep -r Data\Results\TEXT\RandomFragment\Text >ssdeepFregRan2.text');
						  ...
						  $rslt = file_get_contents('ssdeepFregRan.text', true);
					  $sn=0;
							...
							$t=(int)$_GET['threshold'];
					  		$rw="";
								...
								$dir1    = 'Data\Results\TEXT\RandomFragment\Result';
								$files1 = scandir($dir1);

								$dir2    = 'Data\Results\TEXT\RandomFragment\Text';
								$files2 = scandir($dir2);
