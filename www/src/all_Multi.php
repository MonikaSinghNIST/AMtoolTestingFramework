...
<body id="menu1"> 
	<div id="mainWrapper">
		...
		<div id="breadcrumb">Related Document Identification (ssdeep, TEXT, Multiple common)</div> 
						  ...
						  $rslt = file_get_contents('..\Final_Report_Fragment\ssdeepMultipleBlockText.text', true);
							...
							$t=(int)$_GET['threshold'];
					  		$rw="";
								...
								$dir1    = '..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source1';
								$files1 = scandir($dir1);

								$dir2    = '..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source2';
								$files2 = scandir($dir2);
   ...
   $numOfFrgmntFl=0;
   $numOfTxtFl=0;
   $fi1 = new FilesystemIterator("..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source1", FilesystemIterator::SKIP_DOTS);
$numOfFrgmntFl=iterator_count($fi1);
$fi2 = new FilesystemIterator("..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source2", FilesystemIterator::SKIP_DOTS);
...
<div id="rightContent">
    	    <div id="breadcrumb">Related Document Identification (sdhash, TEXT, Multiple Common Block)</div> 
  ...
  /*
   ...
   $fi1 = new FilesystemIterator("..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source1", FilesystemIterator::SKIP_DOTS);
$numOfFrgmntFl=iterator_count($fi1);
$fi2 = new FilesystemIterator("..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source1", FilesystemIterator::SKIP_DOTS);
$numOfTxtFl=iterator_count($fi2);
$numOfComprsn=$numOfFrgmntFl*$numOfTxtFl;
...
<tr align="cen" ><td colspan="2" align="center"><input type="submit" align="middle" value="submit"  onClick="location.href = 'FbHashReportSingleCommmonBlockSimilarity.php?scoreFbHashText_SingleCommon=<?php echo $scoreFbHashText_SingleCommon ?>&matchFbHashText_SingleCommon=<?php echo $matchFbHashText_SingleCommon ?>&scoreSdhashText_SingleCommon=<?php echo $scoreSdhashText_SingleCommon ?>&matchSdhashText_SingleCommon=<?php echo $matchSdhashText_SingleCommon ?>&scoreSsdeepText_SingleCommon=<?php echo $scoreSsdeepText_SingleCommon ?>&matchSsdeepText_SingleCommon=<?php echo $matchSsdeepText_SingleCommon ?>';"></td></tr>
