		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	    <div id="breadcrumb"></div> 
			  <div id="breadcrumb">Step 1.</div> 
			  <div id="boxContainer" style="font-size: 2em"><a href="GenerateRelatedDocument.php">Generate the Data Set</a></div>
			  
			  <div id="breadcrumb">Step 2.</div> 
			  <div id="boxContainer" style="font-size: 2em"><a href="evaluateRelatedDocument.php">Perform Test</a></div>
<!--		      <h1>Welcome to the CFTT Federated Testing CD</h1>-->
			  <?php //echo exec('javac -cp "jar/zip4j_1.3.2.jar" testzip.java'); 
			  		//echo exec('java -cp "jar/zip4j_1.3.2.jar;." testzip');
