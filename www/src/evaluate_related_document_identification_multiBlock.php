...
function redirect(){
   ...
   document.getElementById('frm').action = 'SingleBlockIdentification_ssdeep.php?case=1&threshold='+threshold+'&type=Multi';
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (tool== "ssdeep") ) {
   document.getElementById('frm').action = 'SingleBlockIdentification_ssdeep.php?case=2&threshold='+threshold+'&type=Multi';
  }else if((dataSet=="Existing") && (setType == "TEXT") && (tool== "ssdeep")) {
   document.getElementById('frm').action = 'SingleBlockIdentification_ssdeep.php?case=3&threshold='+threshold+'&type=Multi';
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (tool== "ssdeep")) {
   document.getElementById('frm').action = 'SingleBlockIdentification_ssdeep.php?case=4&threshold='+threshold+'&type=Multi';
  }
	
	else if((dataSet=="Existing") && (setType == "DOCX") && (tool== "sdhash")){
   document.getElementById('frm').action = 'SingleBlockIdentification_sdhash.php?case=1&threshold='+threshold+'&type=Multi';
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") && (tool== "sdhash") ) {
   document.getElementById('frm').action = 'SingleBlockIdentification_sdhash.php?case=2&threshold='+threshold+'&type=Multi';
  }else if((dataSet=="Existing") && (setType == "TEXT") && (tool== "sdhash")) {
   document.getElementById('frm').action = 'SingleBlockIdentification_sdhash.php?case=3&threshold='+threshold+'&type=Multi';
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") && (tool== "sdhash")) {
   document.getElementById('frm').action = 'SingleBlockIdentification_sdhash.php?case=4&threshold='+threshold+'&type=Multi';
  }
  
  else	if((dataSet=="Existing") && (setType == "DOCX") ){
   document.getElementById('frm').action = 'SingleBlockIdentification_newTool.php?case=1&threshold='+threshold+'&type=Multi&tool='+tool;
  }else if((dataSet=="UserGenerated") && (setType == "DOCX") ) {
   document.getElementById('frm').action = 'SingleBlockIdentification_newTool.php?case=2&threshold='+threshold+'&type=Multi&tool='+tool;
  }else if((dataSet=="Existing") && (setType == "TEXT")) {
  	document.getElementById('frm').action = 'SingleBlockIdentification_newTool.php?case=3&threshold='+threshold+'&type=Multi&tool='+tool;
  }else if((dataSet=="UserGenerated") && (setType == "TEXT") ) {
   document.getElementById('frm').action = 'SingleBlockIdentification_newTool.php?case=4&threshold='+threshold+'&type=Multi&tool='+tool;
  }
...
<body id="menu1"> 
	<div id="mainWrapper">
		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	    <div id="breadcrumb">Related Document Detection ➤ <a href="evaluateRelatedDocument.php">Test Cases</a> ➤ <a href="evaluate_related_document_identification_multiBlock.php"> Multiple Common Block Identification</a></div> 
