...
<div id="rightContent">
				  ...
				  <?php
						...
						$FlIndx2=9;
				  		...
				  		$fldr1='';	
						$fldr2='';
						$out1='..\temp\\'.$tool.'_SingleBlock1.text';
						$out2='..\temp\\'.$tool.'_SingleBlock2.text';
				  ...
				  if($_GET['type']=="Multi"){
					  ...
					  switch ($caseValue) {
						  ...
						  case 1:
							...
							//'..\Tools\\' .$tool. ' -d '.$fldr1.' -o '.
							echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Docx\Source1 -o '.$out1);
						    echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Docx\Source2 -o '.$out2);
							$exectnTime_end=time();
						...
						case 2:
							$exectnTime_start=time();	
							echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\MultipleCommonBlock\Results\Docx\Source1 -o '.$out1);
						    echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\MultipleCommonBlock\Results\Docx\Source2 -o '.$out2);
							$exectnTime_end=time();
							$exectnTime=$exectnTime_end-$exectnTime_start;
						...
						case 3:
							$exectnTime_start=time();
							echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source1 -o '.$out1);
						    echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\MultipleCommonBlock\Text\Source2 -o '.$out2);
							$exectnTime_end=time();
							$exectnTime=$exectnTime_end-$exectnTime_start;
						...
						case 4:
							$exectnTime_start=time();
							echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\MultipleCommonBlock\Results\Text\Source1 -o '.$out1);
						    echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\MultipleCommonBlock\Results\Text\Source2 -o '.$out2);
							$exectnTime_end=time();
							$exectnTime=$exectnTime_end-$exectnTime_start;  
					...
					switch ($caseValue) {
						...
						case 1:
							...
							$exectnTime_start=time();
							echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\SingleCommonBlock\Docx\Source1 -o '.$out1);
						    echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\SingleCommonBlock\Docx\Source2 -o '.$out2);	
							$exectnTime_end=time();
							$exectnTime=$exectnTime_end-$exectnTime_start;
						...
						case 2:
							...
							$exectnTime_start=time();
							echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\SingleCommonBlock\Results\Docx\Source1 -o '.$out1);
						    echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\SingleCommonBlock\Results\Docx\Source2 -o '.$out2);	
							$exectnTime_end=time();
							$exectnTime=$exectnTime_end-$exectnTime_start;
						...
						case 3:
							...
							$exectnTime_start=time();
							echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\SingleCommonBlock\Text\Source1 -o '.$out1);
							echo exec('..\Tools\\' .$tool. ' -d ..\Data\RelatedDocumetSimilarity\SingleCommonBlock\Text\Source2 -o '.$out2);
							$exectnTime_end=time();
							$exectnTime=$exectnTime_end-$exectnTime_start;
						...
						case 4:
							$exectnTime_start=time();
							echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\SingleCommonBlock\Results\Text\Source1 -o '.$out1);
						    echo exec('..\Tools\\' .$tool. ' -d ..\DataUserGenerated\RelatedDocument\SingleCommonBlock\Results\Text\Source2 -o '.$out2);
							$exectnTime_end=time();
							$exectnTime=$exectnTime_end-$exectnTime_start;
						...
						default :
						  ...
						  $resultFile='..\temp\\'.$tool.'_SingleBlock.text';
...
?>
           ...
           <div id="breadcrumb">Related Document Detection ➤ <a href="evaluateRelatedDocument.php">Test Cases</a> ➤ <?php if($testType=="Single"){ ?> <a href="evaluate_related_document_identification.php"> <?php echo $testType; ?> Common Block Identification</a><?php }else{ ?><a href="evaluate_related_document_identification_multiBlock.php"> <?php echo $testType; ?> Common Block Identification</a> <?php } ?> ➤ Tool : <?php echo $tool; ?> &nbsp;&nbsp; File type : <?php echo $docType; ?></div> 
           ...
           <table id="table<?php echo $tblid; ?>" style="width: 100%; height: 100%;">
				  ...
				  ?>
                      ...
                      <?php $scoreNewToolText_SingleCommon=$Final_scb_score50."-".$Final_scb_score40."-".$Final_scb_score30."-".$Final_scb_score20."-".$Final_scb_score10."-".$Final_scb_score5."-".$Final_scb_score4."-".$Final_scb_score3."-".$Final_scb_score2."-".$Final_scb_score1; ?>
...
<?php 
					  $matchNewToolText_SingleCommon=$Final_scb_match50."-".$Final_scb_match40."-".$Final_scb_match30."-".$Final_scb_match20."-".$Final_scb_match10."-".$Final_scb_match5."-".$Final_scb_match4."-".$Final_scb_match3."-".$Final_scb_match2."-".$Final_scb_match1; 
					  ?>                    
...
<div id="breadcrumb">Performance Analysis (<?php echo $tool; ?>, <?php echo $docType; ?>, <?php echo $testType; ?> common)</div> 		  
