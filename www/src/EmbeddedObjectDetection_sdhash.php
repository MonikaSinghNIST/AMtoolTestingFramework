            ...
            <div id="breadcrumb">Tool: <span style="color:#333">sdhash</span>  &nbsp;&nbsp; File type : <?php if(($_GET['case']==5)||($_GET['case']==6)||($_GET['case']==7)||($_GET['case']==8)||($_GET['case']==13)||($_GET['case']==14)||($_GET['case']==15)||($_GET['case']==16)){ ?><span style="color:#333">Docx</span> <?php }else{ ?><span style="color:#333">PPTX</span><?php } ?> &nbsp;&nbsp; Embedded object type :&nbsp;&nbsp; <?php if(($_GET['case']==1)||($_GET['case']==9) || ($_GET['case']==5)||($_GET['case']==13)){ ?><span style="color:#333">JPEG</span><?php }else if(($_GET['case']==2)||($_GET['case']==10)||($_GET['case']==6)||($_GET['case']==14)){ ?><span style="color:#333">BMP</span><?php }else if(($_GET['case']==3)||($_GET['case']==11)||($_GET['case']==7)||($_GET['case']==15)){ ?><span style="color:#333">TIFF</span><?php }else if(($_GET['case']==4)||($_GET['case']==12)||($_GET['case']==8)||($_GET['case']==16)){ ?><span style="color:#333">GIF</span><?php } ?> </div>  
			  ...
			  <form id="frm" method="get" action="javascript:redirect();">
                  ...
                  (Calculated by the tool)</td></tr>
						...
						$out1='..\temp\sdhash_embeddedObject1';
					    $out2='..\temp\sdhash_embeddedObject2';
						
						if (file_exists($out1.'.sdbf')) {
							unlink($out1.'.sdbf');
						} 
						if (file_exists($out2.'.sdbf')) {
							unlink($out2.'.sdbf');
						} 
						...
						/*		
						case 17:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\JPEG\Results\Embedded_Files\*.pptx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\Jpeg\*.jpg -o sdhash_embedded_object2');
						...
						case 18:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\JPEG\Results\Embedded_Files_without_Images\*.pptx -o sdhash_embedded_object1');
							echo exec('..\ExistingTools\\sdhash Data\Images\JPEG\*.jpg -o sdhash_embedded_object2');
						...
						case 19:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\BMP\Results\Embedded_Files\*.pptx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\BMP\*.bmp -o sdhash_embedded_object2');
						...
						case 20:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\BMP\Results\Embedded_Files_without_Images\*.pptx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\BMP\*.bmp -o sdhash_embedded_object2');
						...
						case 21:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\TIFF\Results\Embedded_Files\*.pptx -o sdhash_embedded_object1');
							echo exec('..\ExistingTools\\sdhash Data\Images\TIFF\*.tif -o sdhash_embedded_object2');
						...
						case 22:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\TIFF\Results\Embedded_Files_without_Images\*.pptx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\TIFF\*.tif -o sdhash_embedded_object2');
						...
						case 23:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\GIF\Results\Embedded_Files\*.pptx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\GIF\*.gif -o sdhash_embedded_object2');
						...
						case 24:
							echo exec('..\ExistingTools\\sdhash Data\Results\PPTX\GIF\Results\Embedded_Files_without_Images\*.pptx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\GIF\*.gif -o sdhash_embedded_object2');
						...
						case 25:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\JPEG\Embedded_Files\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\Jpeg\*.jpg -o sdhash_embedded_object2');
						...
						case 26:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\JPEG\Embedded_Files_without_Images\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\Jpeg\*.jpg -o sdhash_embedded_object2');
						...
						case 27:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\BMP\Embedded_Files\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\BMP\*.bmp -o sdhash_embedded_object2');
						...
						case 28:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\BMP\Embedded_Files_without_Images\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\BMP\*.bmp -o sdhash_embedded_object2');
						...
						case 29:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\TIFF\Embedded_Files\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\TIFF\*.tif -o sdhash_embedded_object2');
						...
						case 30:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\TIFF\Embedded_Files_without_Images\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\TIFF\*.tif -o sdhash_embedded_object2');
						...
						case 31:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\GIF\Embedded_Files\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\GIF\*.gif -o sdhash_embedded_object2');
						...
						case 32:
							echo exec('..\ExistingTools\\sdhash Data\Results\DOCX\GIF\Embedded_Files_without_Images\*.docx -o sdhash_embedded_object1');
						    echo exec('..\ExistingTools\\sdhash Data\Images\GIF\*.gif -o sdhash_embedded_object2');
					  ...
					  //echo exec('ssdeep -r Data\Docx');
						 ...
						 //echo exec('sdhash Data\Images\Jpeg\*.jpg -o img_result_embedded_jpeg_docx2');
						  ...
						  $rslt= exec('..\ExistingTools\\sdhash -c '.$out1.'.sdbf '.$out2.'.sdbf | sort > ..\temp\sdhash_embeddedObject.text');
						  
						  $rslt = file_get_contents('..\temp\sdhash_embeddedObject.text', true);
						  $sn=0;
						  $tp=0;
						  $tn=0;
						  $fp=0;
...
//*/
			  ...
			  //unlink("sdhash_embedded_object.text");
			  //unlink("sdhash_embedded_object1.sdbf");
			  //unlink("sdhash_embedded_object2.sdbf");
