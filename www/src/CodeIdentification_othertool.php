...
<body id="menu1"> 
	<div id="mainWrapper">
		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	    <div id="breadcrumb">Identification of code version  ➤ <a href="evaluate_code_search.php"> Perform specific tests</a> ➤ Tool : fbhash ➤ File type : <?php if((int)$_GET['case']==1){ ?>EXE <?php }else{ ?>DLL<?php } ?></div> 
			  ...
			  <form id="frm" method="get" action="javascript:redirect();">
				  ...
				  <table id="table<?php echo $tblid; ?>" >
					  ...
					  <tr  style="font-family: Arial, 'Century Gothic'; background-color: #0e375d; color:white; text-align: center;align-content: center;align-items: center; width: 1000px;"><td style="text-align: center; width: 5%;">S.No.</td><td style="text-align: center; width: 35%">Document1</td><td style="text-align: center; width: 35%">Document2</td><td style="text-align: center;width: 25%">Similarity<br/> (Calculated by the scheme)</td></tr>
						...
						$FlIndx2=9;
					  	$expldSign="__";
						$dirpathh=dirname(__FILE__);
						$outputfl='..\temp\\'.$tool.'CodeIdentification.text';
						$resultFile='..\temp\\'.$tool.'_CodeIdentificationResult.text';
						...
						case 1:
							...
							$exestr='..\Tools\\' .$tool. ' -d '.$fldr1.' -o '.$outputfl;
							echo exec($exestr);
							$expldSign="_";
							break;
								
						case 2:
							//$outputfl=$tool.'CodeIdentification';
							$fldr1='..\Data\ProgramFiles\DllSmall';	
							$fldr2='..\Data\ProgramFiles\DllSmall';
							$exestr='..\Tools\\' .$tool. ' -d '.$fldr1.' -o '.$outputfl;
							echo exec($exestr);
						//echo exec('sdhash Data\ProgramFiles\Dll\*.dll -o sdhashCodeIdentification');
						  ...
						  $rslt= exec('..\Tools\\'.$tool.' -c '.$outputfl.' '.$outputfl.' >'.$resultFile);
                  ...
                  <tr  style="font-family: Arial, 'Century Gothic'; background-color: #0e375d; color:white; text-align: center;align-content: center;align-items: center; width: 1000px;"><td style="text-align: center; width: 5%;">S.No.</td><td style="text-align: center; width: 35%">Document1</td><td style="text-align: center; width: 35%">Document2</td><td style="text-align: center;width: 25%">Similarity<br/> (Calculated by the scheme)</td></tr>
					  ...
					  <?php 
						  ...
						  $embddFl=strtolower(trim($embdFl_arr[1]));
						  $imgFl=strtolower(trim($imgFl_arr[1]));	  
		  ...
		  foreach($cdir2 as $key2 => $value2){
			...
			if (!in_array($value2,array(".",".."))) 
      		{ 
				...
				//echo $embdFl_arr[1]."****".$imgFl_arr[1]."-----\n"; 
				//concatenate if it has more than one '_'
