...
<body id="menu1"> 
	<div id="mainWrapper">
		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	    <div id="breadcrumb">Fragment Identification ➤ <a href="evaluateFragment.php">Test Cases</a> ➤ <a href="evaluate_fragment_search.php">Fragment Correlation Test</a> ➤ </div> <div id="breadcrumb"> Tool : <span style="color:#333;">sdhash</span> <?php if(($_GET['case']==1)||($_GET['case']==3)){ ?>  &nbsp;File type : <span style="color:#333;">Docx</span> &nbsp;&nbsp;Dataset type : <span style="color:#333;">Sequential </span><?php }else if(($_GET['case']==2)||($_GET['case']==4)){ ?> &nbsp;File type : <span style="color:#333;">Docx</span> &nbsp;&nbsp;Dataset type : <span style="color:#333;">Random</span><?php }else if(($_GET['case']==5)||($_GET['case']==7)){ ?>  &nbsp;File type : <span style="color:#333;">Text</span> &nbsp;&nbsp;Dataset type : <span style="color:#333;">Sequential</span><?php }else if(($_GET['case']==6)||($_GET['case']==8)){ ?> &nbsp;File type : <span style="color:#333;">Text</span> &nbsp;&nbsp;Dataset type : <span style="color:#333;">Random</span><?php } ?></div> 
			  ...
			  <form id="frm" method="get" action="javascript:redirect();">
				  ...
				  <table id="table<?php echo $tblid; ?>" >
					  ...
					  <tr  style="font-family: Arial, 'Century Gothic'; background-color: #0e375d; color:white; text-align: center;align-content: center;align-items: center; width: 1000px;"><td style="text-align: center; width: 5%;">S.No.</td><td style="text-align: center; width: 30%">Fragment</td><td style="text-align: center; width: 30%">Target File</td><td style="text-align: center;width: 25%">Similarity<br/> (Calculated by the scheme)</td><td style="text-align: center;width: 10%">Real Similarity</td></tr>
					    ...
					    $FlIndx1=18;
						$FlIndx2=9;
						$out1='..\temp\sdhashFrag1';
						$out2='..\temp\sdhashFrag2';
					  	$expldSign="_";
					  	switch ($caseValue) {
						...
						case 1:
							...
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Docx\Sequentialfragment\Result\*.docx -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Docx\Sequentialfragment\Docx\*.docx -o '.$out2);	
						...
						case 2:
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Docx\RandomFragment\Result\*.docx -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Docx\RandomFragment\Docx\*.docx -o '.$out2);	
						...
						case 3:
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\DocxData\FromBegnning\Results\*.docx -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\DocxData\FromBegnning\Docx\*.docx -o '.$out2);	
						...
						case 4:
							...
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\DocxData\Random\Results\*.docx -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\DocxData\Random\Docx\*.docx -o '.$out2);
						...
						case 5:
							...
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Text\Sequentialfragment\Result\*.text -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Text\Sequentialfragment\Text\*.text -o '.$out2);
						...
						case 6:
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Text\RandomFragment\Result\*.text -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\Data\FragmentIdentification\Text\RandomFragment\Text\*.text -o '.$out2);	
						...
						case 7:
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\TextData\FromBegnning\Results\*.text -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\TextData\FromBegnning\Text\*.text -o '.$out2);	
						...
						case 8:
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\TextData\Random\Results\*.text -o '.$out1);
							echo exec('..\ExistingTools\\sdhash ..\DataUserGenerated\FragmentIdentification\TextData\Random\Text\*.text -o '.$out2);
						...
						default :
						  ...
						  $rslt= exec('..\ExistingTools\\sdhash -c '.$out1.'.sdbf  '.$out2.'.sdbf | sort >..\temp\sdhashFrag.text');
						  $rslt = file_get_contents('..\temp\sdhashFrag.text', true);
						  $sn=0;
						  $tp=0;
						  $tn=0;
						  $fp=0;
                  ...
                  <tr  style="font-family: Arial, 'Century Gothic'; background-color: #0e375d; color:white; text-align: center;align-content: center;align-items: center; width: 1000px;"><td style="text-align: center; width: 5%;">S.No.</td><td style="text-align: center; width: 30%">Fragment</td><td style="text-align: center; width: 30%">Target File</td><td style="text-align: center;width: 25%">Similarity<br/> (Calculated by the scheme)</td><td style="text-align: center;width: 10%">Real Similarity</td></tr>
                          ...
                          <td style="text-align:center"><?php echo $real_similarity; ?></td></tr>
					  <?php 
