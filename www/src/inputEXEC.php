        ...
        <script type="text/javascript">
			...
			jQuery(document).ready(function($){
                ...
                $.ajax({
					...
					url: "addNewTool.php", //Ajax Action url
                    data: data,
					processData: false,
					contentType: false,
					cache: false,
 ...
 <div class="se-pre-con"></div>
	...
	<div id="mainWrapper">
		...
		<div id="subContentContainer">
    	  ...
    	  <div id="rightContent">
    	    <div id="breadcrumb">Add new tool</div> 
			  <form id="frm" method="post"  action="javascript:copyExe();"  enctype="multipart/form-data">
				  <table>
					 
                      <?php
					  //echo $_GET['setType']."---".$_GET['FragmentType'];
					  ?>
                      <tr style="font-family: Arial, 'Century Gothic'; background-color: #0e375d; color:white; text-align: center;align-content: center;align-items: center;width: 1000px;"><td colspan="2">Add new tool</td></tr>
					  <tr><td width="50%"><br>Enter the executable of the tool</td><td align="right" style="text-align: right"> <div align="right"><br><input accept=".exe" type="file" required="" id="exec" name="exec" ></div></td></tr> 
